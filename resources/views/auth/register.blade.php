            ...
            <div class="card-body row">
                <div class="col-md-6">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">نام و نام خانوداگی</label>
                        ...
                        <div class="row mb-3">
                            <label for="phone" class="col-md-4 col-form-label text-md-end">شماره تلفن</label>
